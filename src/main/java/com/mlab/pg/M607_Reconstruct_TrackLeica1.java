...
public class M607_Reconstruct_TrackLeica1 {

	static Logger LOG = Logger.getLogger(M607_Reconstruct_TrackLeica1.class);
	...
	public static void main(String[] args) {
		...
		hmin = originalVProfile.getMinY()*0.95;
		hmax = originalVProfile.getMaxY()*1.05;
	...
	private static void showVProfiles(XYVectorFunction originalData, XYVectorFunction resultData) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
        		charter = new Charter("M-607.- Track Leika-1", "S", "Z");
