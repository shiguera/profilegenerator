...
public class M607_Reconstruct_TrackLeica2 {

	static Logger LOG = Logger.getLogger(M607_Reconstruct_TrackLeica2.class);
	...
	private static void showVProfiles(XYVectorFunction originalData, XYVectorFunction resultData) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
        		charter = new Charter("M-607.- Track Leika-2", "S", "Z");
