...
public class ReconstructM607_TrackLeika_1 {
	...
	public static void main(String[] args) {
		...
		try {
			rec = new IterativeReconstructor(gradeData, 906.26, interpolationStrategy);
		} catch (Exception e) {
		...
		try {
			...
			reconstructor = new Reconstructor(gradeData, baseSize, thresholdSlope, 906.26, interpolationStrategy);
		} catch(Exception e) {
