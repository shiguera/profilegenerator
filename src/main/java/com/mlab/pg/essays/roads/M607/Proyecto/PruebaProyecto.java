...
public class PruebaProyecto {
	...
	public PruebaProyecto() {
		...
		String outfilename = IOUtil.composeFileName(path, "M607_Proyecto_EstadoAlineacionesOriginal.txt");
		File outfile = new File(outfilename);
		int result = VerticalProfileWriter.writeVerticalProfile(outfile, vprofile, "M-607  Estado de alineaciones del proyecto");
	...
	public static void main(String[] args) {
		...
		outfilename = IOUtil.composeFileName(path, "M607_Proyecto_EstadoAlineacionesOriginal.txt");
		File outfile = new File(outfilename);
		int result = VerticalProfileWriter.writeVerticalProfile(outfile, vprofile, "M-607  Estado de alineaciones del proyecto");
		System.out.println("Result: " + result);
