 ...
 *
 */
public class Essay_20_M513_Axis_RoadRecorder {
	...
	public Essay_20_M513_Axis_RoadRecorder() {
		
		essayData = new EssayData();
		essayData.setEssayName("Ensayo 20.- M-613 - Eje promedio 2 trazas - RoadRecorder");
		...
		essayData.setXyzFileName("M513_RoadRecorder_2013-06-27_Axis_1.csv");
		essayData.setSgFileName(TrackUtil.generateSGFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setSzFileName(TrackUtil.generateSZFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setReportFileName("Essay_20_M513_Axis_RoadRecorder.txt");
	...
	public static void main(String[] args) {
		...
		Essay_20_M513_Axis_RoadRecorder essay = new Essay_20_M513_Axis_RoadRecorder();
		essay.doIterative();
