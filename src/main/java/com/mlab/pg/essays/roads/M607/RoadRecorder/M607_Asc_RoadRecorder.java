 ...
 *
 */
public class M607_Asc_RoadRecorder {
	...
	public M607_Asc_RoadRecorder() {
		
		essayData = new EssayData();
		essayData.setEssayName("M-607 Ascendente - RoadRecorder - Traza completa");
		...
		essayData.setReportFileName("M607_Asc_RoadRecorder.txt");
	...
	public static void main(String[] args) {
		...
		M607_Asc_RoadRecorder essay = new M607_Asc_RoadRecorder();
		essay.doIterative();
