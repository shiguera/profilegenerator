 ...
 *
 */
public class M608_Asc_Garmin_20170419 {
	...
	public M608_Asc_Garmin_20170419() {
		
		essayData = new EssayData();
		essayData.setEssayName("m-608 - Ascendente - GPS Garmin - 20170419");
		...
		essayData.setXyzFileName("M608_Asc_20170419.csv");
		essayData.setSgFileName(TrackUtil.generateSGFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setSzFileName(TrackUtil.generateSZFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setReportFileName("M608_Asc_20170419.txt");
	...
	public static void main(String[] args) {
		...
		M608_Asc_Garmin_20170419 essay = new M608_Asc_Garmin_20170419();
		essay.doIterative();
