...
public class M607_Asc_Garmin {
	...
	public M607_Asc_Garmin() {
		
		essayData = new EssayData();
		essayData.setEssayName("M-607 Ascendente - GPS Garmin - Traza completa");
		essayData.setGraphTitle("M-607 Ascendente - GPS Garmin - Traza completa");
		...
		essayData.setReportFileName("M607_Asc_Garmin.txt");
	...
	public static void main(String[] args) {
		...
		M607_Asc_Garmin essay = new M607_Asc_Garmin();
		essay.doIterative();
