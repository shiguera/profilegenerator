 ...
 *
 */
public class M633_Descendente_2 {
	...
	public M633_Descendente_2() {
		...
		essayData.setXyzFileName("20140219_121352_xyz.csv");
		essayData.setSgFileName(TrackUtil.generateSGFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setSzFileName(TrackUtil.generateSZFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setReportFileName("M633-Descendente-2.txt");
		essayData.setInterpolationStrategy(InterpolationStrategyType.EqualArea);
		essayData.setStartS(500.0);
		essayData.setEndS(6000.0);
	...
	public static void main(String[] args) {
		...
		M633_Descendente_2 essay = new M633_Descendente_2();
		essay.doIterative();
