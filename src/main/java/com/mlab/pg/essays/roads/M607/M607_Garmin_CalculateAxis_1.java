...
public class M607_Garmin_CalculateAxis_1 {

	public M607_Garmin_CalculateAxis_1() {
	...
	public static void main(String[] args) {
		...
		String outfilenamecomplete = IOUtil.composeFileName(path, "M607_Garmin_2017-03-09_Axis.csv");
