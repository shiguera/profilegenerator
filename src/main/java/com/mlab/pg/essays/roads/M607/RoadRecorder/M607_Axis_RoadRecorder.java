 ...
 *
 */
public class M607_Axis_RoadRecorder {
	...
	public M607_Axis_RoadRecorder() {
		
		essayData = new EssayData();
		essayData.setEssayName("M-607 Ascendente - RoadRecorder - Eje promediado 2 trazas");
	...
	public static void main(String[] args) {
		...
		M607_Axis_RoadRecorder essay = new M607_Axis_RoadRecorder();
		essay.doIterative();
