 ...
 *
 */
public class Essay_18_M513_Asc_RoadRecorder2 {
	...
	public Essay_18_M513_Asc_RoadRecorder2() {
		
		essayData = new EssayData();
		essayData.setEssayName("Ensayo 18.- M-613 Ascendente - RoadRecorder");
		...
		essayData.setXyzFileName("20130627_134235.csv");
		essayData.setSgFileName(TrackUtil.generateSGFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setSzFileName(TrackUtil.generateSZFileFromXYZFile(essayData.getInPath(), essayData.getXyzFileName(), 1));
		essayData.setReportFileName("Essay_18_M513_Asc_RoadRecorder.txt");
	...
	public static void main(String[] args) {
		...
		Essay_18_M513_Asc_RoadRecorder2 essay = new Essay_18_M513_Asc_RoadRecorder2();
		essay.doIterative();
