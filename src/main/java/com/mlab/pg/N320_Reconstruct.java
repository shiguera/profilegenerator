...
public class N320_Reconstruct {

	static Logger LOG = Logger.getLogger(N320_Reconstruct.class);
	...
	public static void main(String[] args) {
		...
		switch(option) {
			...
			case ITERATIVE:
				...
				resultVProfileSample = resultVProfile.getSample(resultVProfile.getStartS(), 
						resultVProfile.getEndS(), rec.getSeparacionMedia(), true);
				showVProfiles(reconstructor.getOriginalVerticalProfilePoints(), resultVProfileSample);
				break;
		}
